...
#pragma once
    ...
    /*#ifdef _MT
    #pragma comment(lib, "tracetool-mt.lib")
#else
    #pragma comment(lib, "tracetool-md.lib")
    #endif*/
#else
    #define INIT_CONSOLE
    #define TRACE_CLEAR
...
class CACTUS_API TraceNodeBase
{
public :
...
class CACTUS_API TraceToSend : public TraceNodeBase
{
    friend TraceNodeEx ;
    friend WinTrace ;
    friend TraceNode ;
...
/// </summary>
class CACTUS_API TraceNode : public TraceToSend
{
    friend WinTrace ;
    friend TraceToSend ;
protected :
...
class CACTUS_API TraceNodeEx : public TraceNodeBase //Base
{
...
class CACTUS_API WinTrace : public TraceToSend
{
